...
Invoke-Command -ComputerName 10.1.0.11 -Credential $credential -ScriptBlock {param([string]$mail) New-MailboxExportRequest -Mailbox $mail -FilePath ("C:\Exports\" + "$mail" + ".pst")}